...
var deflat=34.975453;
var deflng=138.382632;
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      for (var i = 1; i < csvList.length -1; i++) {
        ...
        visitinfo.push('<div id="infowindow">'+csvList[i][8]+'</br>'+csvList[i][9]+'</br>'+csvList[i][13]+'</br><a href="http://maps.google.com/maps?daddr='+csvList[i][5]+','+csvList[i][6]+'&saddr=%E7%8F%BE%E5%9C%A8%E5%9C%B0&dirflg=d&t=m">　現在地からルート検索</a>');
      };
